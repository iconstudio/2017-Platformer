...
<tileset name="vexodus_tileset" tilewidth="20" tileheight="20" tilecount="14" columns="0">
 ...
 <tile id="4" type="brick_stone">
  <image width="20" height="20" source="stonewall_0.png"/>
 </tile>
 <tile id="7" type="brick_metal">
  <image width="20" height="20" source="metalic_black_0.png"/>
 </tile>
 <tile id="8" type="block_metal">
  <image width="20" height="20" source="BlockMetal_0.png"/>
 </tile>
 <tile id="9" type="block_red">
  <image width="20" height="20" source="Block_0.png"/>
 </tile>
 ...
 <tile id="20" type="forest_platform">
  <image width="20" height="20" source="sLushFlat_0.png"/>
 </tile>
 <tile id="26" type="dirt">
  <image width="20" height="20" source="brick_mine_0.png"/>
 </tile>
 ...
 <tile id="31">
  <image width="20" height="20" source="brick_mine_bot.png"/>
 </tile>
</tileset>

...
__all__ = [
              ...
              "draw_set_color", "draw_get_color", "draw_background_color_set", "draw_rectangle",
...
def open_canvas(w=int(800), h=int(600), sync=False, full=False):
    ...
    window = SDL_CreateWindow(caption, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, w, h, flags | SDL_WINDOW_BORDERLESS)
    if sync:
